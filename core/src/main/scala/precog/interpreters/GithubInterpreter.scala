...
class GithubInterpreter[F[_]: Sync](httpClient: Client[F], accessToken: Option[String])(
...
object GithubInterpreter {
  ...
  def apply[F[_]: Sync](httpClient: Client[F], accessToken: Option[String] = None)(
      implicit config: GithubConfig): GithubInterpreter[F] =
